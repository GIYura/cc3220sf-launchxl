...
int main (void)
{
    ...
    m_gpio1.ops = gpioOps;
    m_gpio1.ops->open(&m_gpio1, PIN_GPIOA1_3, PIN_MODE_OUTPUT, PIN_TYPE_NO_PULL, PIN_STRENGTH_HIGH, PIN_CONFIG_PUSH_PULL, PIN_STATE_LOW);

    m_gpio2.ops = gpioOps;
    m_gpio2.ops->open(&m_gpio2, PIN_GPIOA1_2, PIN_MODE_OUTPUT, PIN_TYPE_NO_PULL, PIN_STRENGTH_HIGH, PIN_CONFIG_PUSH_PULL, PIN_STATE_LOW);
